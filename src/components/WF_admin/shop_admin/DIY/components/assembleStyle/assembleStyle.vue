<template>
    <!-- class="wf-" -->
    <div class="wf-DIY-assembleStyle">
...
<script>
import assembleSet0 from '../assembleSet/assembleSet0.vue'; //商品属性面板
export default {
    name: '',
    props:{
        comProps:Object,
...
@import '@/styles/components/css_WF_admin/shop_admin/DIY/components/assembleStyle/assembleStyle.scss';
</style>