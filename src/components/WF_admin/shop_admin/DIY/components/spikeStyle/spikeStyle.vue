...
<script>
import spikeSet0 from '../spikeSet/spikeSet0.vue'; //商品属性面板
export default {
    name: '',
    props:{
        comProps:Object,
...
@import '@/styles/components/css_WF_admin/shop_admin/DIY/components/spikeStyle/spikeStyle.scss';
</style>