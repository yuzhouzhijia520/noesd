<template>
    <!-- class="wf-" -->
    <div class="wf-DIY-wfGoods0">
        <div class="wf-wfGoods0-title">商品选择</div>
        <div class="wf-wfGoods0-body">
            <el-row>
                ...
                <div class="wf-wfGoods0-add" @click="selectGoods">
                    {{name}}
                </div>
            </el-row>
        ...
        <e-shopslist v-if="showSelectGoods" v-on:handleShopslist="handleShopslist"  v-on:shopSelectedId="handleShopSelectedId" :selectParams="selectParams"></e-shopslist>
    </div>
</template>

<script>
import draggable from "vuedraggable";
import eShopslist from "../linkDialog/eShopslist.vue";
export default {
    name: '',
    props:{
        comProps:Object,
