<template>
    <!-- class="wf-" -->
    <div class="wf-DIY-spikeSet0">
        <div class="wf-spikeSet0-title">
            <el-row>
                活动选择
            </el-row>
            <el-row class="wf-tooltip">
                <label class="wf-tooltip-label">注意:小程序默认不展示已结束的活动</label>
            </el-row>
        </div>
        <div class="wf-spikeSet0-body">
            <el-row>
                ...
                <div class="wf-spikeSet0-add" @click="selectGoods">
                    {{name}}
                </div>
            </el-row>
...
export default {
    ...
    data() {
        return {
            componetType:'spike',////根据传入的不同类型处理传出数据
            title:'秒杀活动',
