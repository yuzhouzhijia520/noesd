<template>
    <!-- class="wf-" -->
    <div class="wf-DIY-assemble0">
        <div class="wf-assemble0-title">活动选择</div>
        <div class="wf-assemble0-body">
            <el-row>
                ...
                <div class="wf-assemble0-add" @click="selectGoods">
                    {{name}}
                </div>
            </el-row>
...
export default {
    ...
    data() {
        return {
            componetType:'assemble',////根据传入的不同类型处理传出数据
            title:'拼团活动',
